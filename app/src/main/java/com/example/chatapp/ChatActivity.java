...
public class ChatActivity extends AppCompatActivity {
    ...
    void callApi(JSONObject jsonObject){
        ...
        Request request = new Request.Builder()
                .url(url)
                .post(body)
                .header("Authorization","Bearer AAAA1eOg09s:APA91bHWJ7kqbcL1eIzj4kK6iT7OJ_HfaMOLvJkcHi6UXyI-VN1ZhncaJi4Qdln4ZCfGM6_eWHNzQNmHm6G8dcMY9AZqIrCPZTQAav2WsV9KSwYq9b6JMILtdzXrZFspita2JkUh9k4p")
                .build();
